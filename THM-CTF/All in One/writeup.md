...
We got a base64 encoded text used `CyberChef` to crack it , we can identify the hash on `hashidentifier` :
<p align="center">
...
Got the rootflag but is base64 encoded used `CyberChef` 

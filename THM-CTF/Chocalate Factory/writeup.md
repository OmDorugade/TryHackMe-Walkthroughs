...
Using the password we cracked for user `charlie` we logged in `ssh` and got user flag :
<p align="center">
...
Using the above command we are root and found a python file :
<p align="center">
  <img width="940" height="150" alt="image" src="https://github.com/user-attachments/assets/81094fb6-5587-45bf-ac31-fb185dad30ea" />
</p>

Using python3 we run the root.py script and it asked for key which we found in task 1 :
<p align="center">
